Practical Machine Learning Assignment - Human Activity Recognition
==================================================================
...
http://groupware.les.inf.puc-rio.br/har. If you use the document you create for this 
...
## Reproducibility 
Due to security concerns with the exchange of R code, your code will not be run during 
the evaluation by your classmates. Please be sure that if they download the repo, they 
